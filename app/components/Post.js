...
function postReducer(state, action) {
  if (action.type === "fetch") {
    ...
    throw new Error("That actiont ype isn't supported")
  }
}
...
export default function Post({ location }) {
  ...
  const [state, dispatch] = React.useReducer(postReducer, { post: null, loadingPost: true, comments: null, loadingComments: true, error: null })
